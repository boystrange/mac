...
(custom-set-variables
 ...
 '(package-selected-packages
   '(idris-mode ac-inf-ruby go-mode yaml-mode exec-path-from-shell rich-minority heaven-and-hell use-package base16-theme markdown-mode smooth-scrolling wc-mode haskell-mode auctex)))
(custom-set-faces
